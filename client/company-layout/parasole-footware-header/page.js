...
import SearchMenu from "../../layout/search/page";

const ParasoleFootwareLtd = () => {
    ...
    <header className="relative w-full">
      ...
      <div className="fixed top-0 left-0 right-0 z-20 bg-opacity-100 bg-[rgba(255,255,255,1.0)] p-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          {/* Navbar and SearchMenu for Larger Screens */}
      ...
      <div className="relative mt-20 pt-2">
        <Image
          src="/assets/images/company-images/parasole-footware1.jpeg"
          alt="Parasole Footwear Ltd Background"
          layout="responsive"
          width={1600}
          height={600}
          quality={100}
...
export default ParasoleFootwareLtd;
