...
const ConsumerHeader = () => {
  ...
  return (
    <header className="relative w-full">
      ...
      <div className="fixed top-0 left-0 right-0 z-20 bg-opacity-100 bg-[rgba(255,255,255,1.0)] p-4 shadow-md">
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="fixed top-0 left-0 w-full h-screen bg-[#263e7a] bg-opacity-100 z-30 flex flex-col justify-center items-center space-y-6 text-white">
          <button
      ...
      <div className="relative mt-20 pt-2">
        <Image
          src="/assets/images/consumer-food-images/header.jpg"
          alt="Consumer Foods Background"
          layout="responsive"
          width={1600}
          height={600}
          quality={100}
